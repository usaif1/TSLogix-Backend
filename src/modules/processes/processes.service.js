...
//     // 3. Upsert the main Inventory (add incoming stock)
//     const expiry = entryData.expiration_date
//       ? toUTC(entryData.expiration_date)
//       : null;
...
//       },
//       update: {
//         quantity: { increment: Number(newEntryOrder.total_qty) },
//       },
//       create: {
//         product_id: newEntryOrder.product_id,
...
//       data: {
//         quantity: Number(inv.quantity) - Number(departureData.total_qty),
//       },
//     });

//     // 4. Log the inventory movement
...
//         notes: departureData.reason || "Stock dispatched via departure order",
//       },
//     });

//     return { departureOrder: newDepartureOrder, inventory: updatedInventory };
//   } catch (error) {
